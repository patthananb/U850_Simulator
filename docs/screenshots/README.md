...
| File | Capture state |
| --- | --- |
| [overview.png](overview.png) | Default 4×6 trays, ready state, perspective view |
| [workcell-layout.png](workcell-layout.png) | Default 4×6 trays, ready state, top view |
| [alignment-result.png](alignment-result.png) | Completed 1×1 batch, 4× playback, default pickup offsets, centered result and one good IC |
